---
lab:
  title: Create a Microsoft 365 Copilot Chat agent
...
1. On the **Configure** tab, ignore the agent icon next to the agent's name for now. In a real-world scenario, you can optionally assign your agent a custom icon. Notice how the **Name** and **Description** fields are filled in based on your finalized description.
...
1. In the **Preview** tab on the top of the form, you can optionally test the agent by selecting several of the suggested prompts or submitting custom prompts. Verify the agent is correctly pulling in data from the knowledge source documents.
