---
lab:
  title: Summarize project communications with the Researcher agent
...
1. In **Microsoft 365**, in the navigation pane, select the **Researcher** agent under the **Agents** section. If the **Researcher** agent doesn't appear, select **All agents** in the navigation pane, and then in the **Agent Store** window, select **Researcher** under the **Built by Microsoft** section.
...
1. Review the **Researcher** agent's response. If it asks any follow-up questions, reply however you wish. For example, **Researcher** may ask questions such as:
    ...
    - Is there any specific format you prefer for the summary, such as a report or a presentation?
...
1. Feel free to submit any other requests to the Researcher agent. Take advantage of this opportunity to learn about the types of requests that it can answer. Either submit some of the following prompts that are of interest to you or enter your own prompts:
    - General research and information gathering:
        - `Summarize all recent documents, chats, and emails related to [Topic X]`.
        ...
        - `Who are the main contributors to [Topic X]`?
    - Meeting preparation:
    ...
    - Document discovery and insights:
        - `Find the latest version of [Topic X] and summarize key updates`.
